...
#include "AirHockeyEnginePluginPCH.h"
...
//============================================================================================================
class AirHockeyEnginePlugin : public IVisPlugin_cl
{
public:
  ...
  {
    return "AirHockeyEnginePlugin";  // must match DLL name
  }
};

//  global plugin instance
AirHockeyEnginePlugin g_myComponents;
...
//--------------------------------------------------------------------------------------------
VEXPORT IVisPlugin_cl* GetEnginePlugin_AirHockeyEnginePlugin(){  return &g_myComponents; }


#if (defined _DLL) || (defined _WINDLL)

  //  The engine uses this to get and initialize the plugin dynamically
  VEXPORT IVisPlugin_cl* GetEnginePlugin(){return GetEnginePlugin_AirHockeyEnginePlugin();}
...
void AirHockeyEnginePlugin::OnInitEnginePlugin()
{
  hkvLog::Info("AirHockeyEnginePlugin:OnInitEnginePlugin()");
...
void AirHockeyEnginePlugin::OnDeInitEnginePlugin()
{
  hkvLog::Info("AirHockeyEnginePlugin:OnDeInitEnginePlugin()");
...
/*
 * Havok SDK - Base file, BUILD(#20150216)
 * 
