...
VIMPORT IVisPlugin_cl* GetEnginePlugin_AirHockeyEnginePlugin();

class AirHockeyApp : public VAppImpl
{
public:
  AirHockeyApp() {}
  virtual ~AirHockeyApp() {}
...
VAPP_IMPLEMENT_SAMPLE(AirHockeyApp);

void AirHockeyApp::SetupAppConfig(VisAppConfig_cl& config)
{
  ...
  */
  ...
  config.m_videoConfig.m_szWindowTitle = "AirHockey";

  config.m_videoConfig.m_bWaitVRetrace = true;
}

void AirHockeyApp::PreloadPlugins()
{
  ...
  VISION_PLUGIN_ENSURE_LOADED(AirHockeyEnginePlugin);
}
...
//---------------------------------------------------------------------------------------------------------
void AirHockeyApp::AfterSceneLoaded(bool bLoadingSuccessful)
{
...
//---------------------------------------------------------------------------------------------------------
bool AirHockeyApp::Run()
{
  return true;
}

void AirHockeyApp::DeInit()
{
  // De-Initialization
  // [...]
}
